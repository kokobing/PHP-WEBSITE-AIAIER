...
README
===========================
A complete MINI enterprise website, including the foreground page and background admin page.  Now uploaded in the Github warehouse because of the end of the project life cycle. The code is for learning only, and prohibits any business related behavior,Site does not use any MVC framework, very suitable for beginners PHP study.
