...
<ul>
<?
$getnewslist=getnewslist(7,'id_newsinfo');
for($i=0;$i<sizeof($getnewslist);$i++){
	$allpic=getnewspicnuminfo($getnewslist[$i][id_newsinfo],2,'opicname as pic');
	$allpic2=getnewspicnuminfo($getnewslist[$i+1][id_newsinfo],2,'opicname as pic');
?>
<li><a href="/upload/news/<?=$allpic[1][pic];?>"  id="imgs00"><img src="/upload/news/<?=$allpic[0][pic];?>" width="200" height="169" /></a><a href="/upload/news/<?=$allpic2[1][pic];?>"  id="imgs00"><img src="/upload/news/<?=$allpic2[0][pic];?>" width="200" height="169"  style="margin-top:10px;" /></a></li>
<? $i++;}?>
